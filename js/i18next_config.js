    ...
    en: {
      translation: {
        ...
        hero: {
          ...
          intro:
            "Java Developer. My focus is mainly on the backend development area using technologies such as <strong>Java</strong>, <strong>Spring Framework / Spring Boot</strong>, <strong>MySQL</strong>, and <strong>Git</strong>, among others related to software development.",
        },
        aboutMeSection: {
          ...
          tools:
            "Tools like Git and databases like MySQL. I also handle Frontend technologies such as HTML, CSS and Typescript.",
          bestPractices:
            "I always try to follow good development practices and apply principles such as <em>SOLID</em>, <em>DRY</em>, and design patterns like <em>MVC</em>.",
        },
        myProjectsSection: {
          global: {
    ...
    es: {
      translation: {
        ...
        hero: {
          ...
          intro:
            "Desarrollador Java. Me enfoco principalmente en el desarrollo backend utilizando tecnologías como <strong>Java</strong>, <strong>Spring Framework / Spring Boot</strong>, <strong>MySQL</strong>, y <strong>Git</strong>, entre otras relacionadas con el desarrollo de software.",
          learnMore: "Saber Más",
        },
        aboutMeSection: {
          intro:
        ...
        myProjectsSection: {
          ...
          projects: [
            ...
            {
              description:
                "El proyecto esta compuesto por una API que proporciona operaciones CRUD para facilitar la gestion de informacion de alumnos, profesores y dojos de una escuela de artes marciales chinas. Ademas de un cliente web que consuma la API e interactue de manera amigable con los usuarios, permitiendo registrarse y acceder para consultar, agregar, modificar y eliminar la informacion segun su rol de usuario. El cliente web tambien proporciona comunicación con el usuario a traves de email, notificandole cuando su solicitud de cuenta sea aceptada o rechazada.",
              startDate: "Ago 2024",
              endDate: "-",
              status: "Aún en desarrollo",
            },
